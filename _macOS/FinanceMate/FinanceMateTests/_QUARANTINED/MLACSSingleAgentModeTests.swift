...
final class MLACSSingleAgentModeTests: XCTestCase {
    ...
    func testSystemCapabilityAnalysis() throws {
    ...
    func testPerformanceClassClassification() throws {
    ...
    func testModelCategorization() throws {
    ...
    func testModelRecommendationForSpecificSystem() throws {
    ...
    func testComplexityAnalysis() throws {
    ...
    func testUpgradeSuggestionGeneration() throws {
    ...
    func testLocalModelSetupWizardWorkflow() throws {
    ...
    func testSetupWizardErrorHandling() throws {
    ...
    func testFullSingleAgentModeWorkflow() throws {
        ...
        XCTAssertFalse(response.isEmpty, "Should provide response to simple query")
        XCTAssertLessThan(response.responseTime, 30.0, "Response should be within acceptable time")
    }

    func testUpgradePathTransition() throws {
    ...
    func testModelRecommendationPerformance() throws {
    ...
    func testSystemAnalysisPerformance() throws {
