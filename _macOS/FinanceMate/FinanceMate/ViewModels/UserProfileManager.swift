...
class UserProfileManager: ObservableObject {
    ...
    func createAccount(name: String, email: String, password: String) -> (success: Bool, user: User?, error: String?) {
        setLoading(true)
        clearError()
    ...
    func resetPassword(email: String) -> (success: Bool, error: String?) {
        setLoading(true)
        clearError()
    ...
    func updateUserProfile(name: String? = nil, email: String? = nil, preferredCurrency: String? = nil, timezone: String? = nil) -> (success: Bool, error: String?) {
