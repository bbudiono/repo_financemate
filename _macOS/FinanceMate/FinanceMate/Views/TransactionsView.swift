...
// Issues & Complexity Summary: SwiftUI layout, Core Data integration, glassmorphism styling, filtering UI, search
// functionality
        ...
        VStack(spacing: 16) {
            ...
            HStack {
                ...
                Button(action: {
                    ...
                    HStack(spacing: 6) {
                        Image(
                            systemName: hasActiveFilters ? "line.horizontal.3.decrease.circle.fill" :
