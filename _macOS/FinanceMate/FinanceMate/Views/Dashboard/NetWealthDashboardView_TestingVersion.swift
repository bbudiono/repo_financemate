...
struct NetWealthDashboardView_TestingVersion: View {
        ...
        ScrollView {
            LazyVStack(spacing: 24) {
                ...
                VStack(spacing: 16) {
                    ...
                    Text("Total Net Wealth: $\(viewModel.totalNetWealth, specifier: "%.2f")")
                        .font(.title2)
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text("Assets: \(viewModel.assets.count) items")
                        .font(.caption)
                    
                    Text("Liabilities: \(viewModel.liabilities.count) items")
                        .font(.caption)
                }
                .padding()
...
#Preview {
    NavigationView {
        NetWealthDashboardView_TestingVersion()
    }
