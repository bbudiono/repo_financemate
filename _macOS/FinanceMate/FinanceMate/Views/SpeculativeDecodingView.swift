...
struct SpeculativeDecodingView: View {
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    .disabled(!isEnabled)
                    .onChange(of: aggressiveness) { newValue in
                ...
                HStack(spacing: 12) {
                    ...
                    .buttonStyle(isMonitoring ? .bordered : .borderedProminent)
                    .disabled(!isEnabled)
                }
            }
        }
    ...
    private func loadCurrentSettings() {
        ...
        print("🔧 Loading speculative decoding settings...")
    }
    
    private func handleToggleChange(_ newValue: Bool) {
        print("🔧 Speculative decoding \(newValue ? "enabled" : "disabled")")
        if newValue {
    ...
    private func handleAggressivenessChange(_ newValue: Double) {
        print("🔧 Aggressiveness set to \(Int(newValue * 100))%")
    }
    
    private func handleMaxTokensChange(_ newValue: Double) {
        print("🔧 Max tokens set to \(Int(newValue))")
    }
    
    private func startSpeculativeDecoding() {
        print("🚀 Starting speculative decoding with model: \(selectedModel)")
        // Initialize speculative decoding
    }
    
    private func stopSpeculativeDecoding() {
        print("⏹️ Stopping speculative decoding")
    ...
    private func toggleMonitoring() {
        isMonitoring.toggle()
        print("📊 Monitoring \(isMonitoring ? "started" : "stopped")")
    }
