...
public class MultiEntityWealthService: ObservableObject {
    ...
    public func calculateMultiEntityWealth() {
        isLoading = true
        errorMessage = nil
        ...
        do {
            ...
            for entity in entities {
                let entityBreakdown = calculateEntityWealth(entity: entity)
            ...
            let crossEntityAnalysis = performCrossEntityAnalysis(
    ...
    private func calculateEntityWealth() -> EntityWealthBreakdown {
    ...
    private func performCrossEntityAnalysis() -> CrossEntityAnalysis {
    ...
    private func calculatePerformanceMetrics() -> EntityPerformanceMetrics {
