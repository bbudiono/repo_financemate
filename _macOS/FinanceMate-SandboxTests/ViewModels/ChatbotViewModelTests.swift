...
final class ChatbotViewModelTests: XCTestCase {
    ...
    func testSendMessage() throws {
        ...
        chatbotViewModel.sendMessage(testMessage)
    ...
    func testExpenseReportQuery() throws {
    ...
    func testPropertyInvestmentExclusionQuery() throws {
    ...
    func testCreateTransactionCommand() throws {
        let command = "Create a new transaction for $50 coffee expense"
        
        chatbotViewModel.sendMessage(command)
    ...
    func testGenerateReportCommand() throws {
    ...
    func testContextAwareness() throws {
        // First, ask about transactions
        chatbotViewModel.sendMessage("Show me my recent transactions")
        
        // Then ask a follow-up that requires context
        chatbotViewModel.sendMessage("What's the total amount?")
    ...
    func testNetworkErrorHandling() throws {
        ...
        chatbotViewModel.sendMessage("Test message")
...
// COMPREHENSIVE FIX: Removed ALL Swift Concurrency patterns to eliminate TaskLocal crashes
        self.chatbotViewModel.sendMessage(message)
            }
        }
    ...
    func testLargeConversationHistory() throws {
        // Test with 50 messages to ensure performance
        for i in 1...50 {
            chatbotViewModel.sendMessage("Test message \(i)")
        }
