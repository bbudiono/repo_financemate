...
public struct RealTimeFinancialInsightsView: View {
    ...
    @State private var selectedInsightType: FinancialInsightType?
    @State private var showingInsightDetails = false
    @State private var selectedInsight: EnhancedFinancialInsight?
...
struct RealTimeInsightCardView: View {
    ...
    private var typeColor: Color {
        switch insight.type {
        case .spendingPattern, .spending: return .blue
        case .incomeAnalysis, .income: return .green
        case .budgetRecommendation, .budgets: return .purple
...
extension FinancialInsightType {
    var displayName: String {
        switch self {
        case .spendingPattern, .spending: return "Spending"
        case .incomeAnalysis, .income: return "Income"
        case .budgetRecommendation, .budgets: return "Budget"
