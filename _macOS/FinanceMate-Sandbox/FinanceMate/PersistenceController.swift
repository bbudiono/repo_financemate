...
class PersistenceController {
  ...
  init(inMemory: Bool = false) {
    ...
    typeAttribute.defaultValue = "expense"

    let externalIdAttribute = NSAttributeDescription()
    externalIdAttribute.name = "externalId"
    externalIdAttribute.attributeType = .stringAttributeType
    externalIdAttribute.isOptional = true

        entity.properties = [
            idAttribute, dateAttribute, amountAttribute, categoryAttribute, noteAttribute, createdAtAttribute, typeAttribute, externalIdAttribute
        ]
