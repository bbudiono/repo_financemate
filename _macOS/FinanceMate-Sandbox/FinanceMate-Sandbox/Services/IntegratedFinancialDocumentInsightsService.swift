...
public class IntegratedFinancialDocumentInsightsService: ObservableObject {
    ...
    @Published public private(set) var systemStatus: IntegratedSystemStatus = IntegratedSystemStatus()
    ...
    private func calculateSystemLoad() -> Double {
        return Double(documentProcessingQueue.count) / 10.0 // Simplified calculation
    }
