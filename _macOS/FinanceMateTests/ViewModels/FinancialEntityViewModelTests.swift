...
final class FinancialEntityViewModelTests: XCTestCase {
    ...
    func testCreateEntity() {
        ...
        // When
        do {
            try viewModel.createEntity(name: entityName, type: entityType, parent: nil)
    ...
    func testCreateEntityWithValidation() {
        // Given
        ...
        do {
            try viewModel.createEntity(name: validName, type: entityType, parent: nil)
        ...
        do {
            try viewModel.createEntity(name: emptyName, type: entityType, parent: nil)
    ...
    func testUpdateEntity() {
        ...
        // When
        do {
            try viewModel.updateEntity(entity: entity, name: updatedName, type: updatedType)
    ...
    func testDeleteEntity() {
        ...
        // When
        do {
            _ = viewModel.deleteEntity(entity)
    ...
    func testCreateChildEntity() {
        ...
        // When
        do {
            try viewModel.createEntity(name: "Child Entity", type: "Personal", parent: parentEntity)
    ...
    func testMoveEntityHierarchy() {
        ...
        // When
        do {
            try viewModel.updateEntity(entity: childEntity, name: "Child", type: "Personal")
    ...
    func testValidateCircularReference() {
        // Given
        ...
        do {
            try viewModel.updateEntity(entity: parentEntity, name: "Parent", type: "Business")
    ...
    func testCurrentEntityPersistence() throws {
        // Given
        ...
        newViewModel.fetchEntities()
        
        // Allow processing time for headless testing
    ...
    func testCurrentEntityValidation() {
        // Given
        ...
        viewModel.setCurrentEntity(nil)
    ...
    func testErrorHandling() {
        ...
        // When
        do {
            try viewModel.updateEntity(entity: invalidEntity, name: "", type: "Personal")
    ...
    func testEntityListUpdates() {
        ...
        // Create new entity
        do {
            try viewModel.createEntity(name: "New Entity", type: "Investment", parent: nil)
    ...
    func testPerformanceEntityLoad() {
        // Given
        let entityCount = 100
