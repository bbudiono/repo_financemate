...
final class SplitAllocationViewModelTests: XCTestCase {
    ...
    func testAddSplitAllocationSuccess() async {
        ...
        XCTAssertEqual(viewModel.splitAllocations.first?.percentage, 60.0, accuracy: 0.01, "Percentage should match")
    ...
    func testUpdateSplitAllocationSuccess() async {
        ...
        await viewModel.fetchSplitAllocations(for: testLineItem)
        XCTAssertEqual(viewModel.splitAllocations.first?.percentage, 75.0, accuracy: 0.01, "Percentage should be updated")
    ...
    func testQuickSplit5050() async {
        ...
        await viewModel.applyQuickSplit(.fiftyFifty, primaryCategory: "Business", secondaryCategory: "Personal", to: testLineItem)
        ...
        XCTAssertEqual(businessSplit?.percentage, 50.0, accuracy: 0.01, "Business split should be 50%")
        XCTAssertEqual(personalSplit?.percentage, 50.0, accuracy: 0.01, "Personal split should be 50%")
    ...
    func testQuickSplit7030() async {
        ...
        await viewModel.applyQuickSplit(.seventyThirty, primaryCategory: "Business", secondaryCategory: "Personal", to: testLineItem)
        ...
        XCTAssertEqual(businessSplit?.percentage, 70.0, accuracy: 0.01, "Business split should be 70%")
        XCTAssertEqual(personalSplit?.percentage, 30.0, accuracy: 0.01, "Personal split should be 30%")
        XCTAssertTrue(viewModel.isValidSplit, "Split should be valid")
    }
