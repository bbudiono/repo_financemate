 ...
 * 
 * Purpose: Testing environment for DocketMate with SANDBOX watermark
 * 
 * Key Features:
...
@main
struct DocketMateSandboxApp: App {
    var body: some Scene {
        WindowGroup {
            VStack {
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("DocketMate Sandbox")
    }
}
