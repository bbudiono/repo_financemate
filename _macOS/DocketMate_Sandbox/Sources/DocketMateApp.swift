...
// Purpose: Main application entry point and lifecycle management for DocketMate (Sandbox environment).
            ...
            ContentView()
                ...
                .onAppear {
                    ...
                    if let window = NSApplication.shared.windows.first {
                        window.title = "DocketMate (Sandbox)"
                    }
                }
        }
        .commands {
            ...
            CommandGroup(replacing: .appTermination) {
                Button("Quit DocketMate (Sandbox)") {
